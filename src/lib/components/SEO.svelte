...
<script lang="ts">
  ...
  let {
    robots = false,
    title = '',
    description = 'Nathan Blaylock is a User Experience Engineer who loves to creatively solve complex problems. This portfolio is a small sample of his public projects.',
    hideHeader = false,
  } : Props = $props();
