<template>
  <b-container class="container my-5">
    ...
    <b-row>
      <div class="col-md-12">
        <p>
          At Nathan Blaylock Media, accessible from
          <a href="/">https://nathanblaylock.com</a>, one of our main priorities
          is the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by Nathan Blaylock
        ...
        <p>
          ...
          shared and/or collect in Nathan Blaylock Media. This policy is not
        ...
        <h3>Log Files</h3>
        <p>
          Nathan Blaylock Media follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, Nathan Blaylock Media uses 'cookies'. These
        ...
        <p>
          Some pages may also use the customer's browser storage, such as local
          storage and session storage. No information saved in either storage
          location is sent to Nathan Blaylock Media LLC.
        </p>
        <h3>Advertising Partners Privacy Policies</h3>
        <P
          >You may consult this list to find the Privacy Policy for each of the
          advertising partners of Nathan Blaylock Media.</P
        >
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Nathan Blaylock Media, which
        ...
        <p>
          Note that Nathan Blaylock Media has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <h3>Third Party Privacy Policies</h3>
        <p>
          Nathan Blaylock Media's Privacy Policy does not apply to other
        ...
        <p>
          Nathan Blaylock Media does not knowingly collect any Personal
...
export default {
    mounted() {
    $nuxt.$emit('change-page-title', 'Privacy Policy')
  },
}
</script>