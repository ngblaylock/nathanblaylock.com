  ...
  <div class="container my-5">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <h1>
          Privacy Policy
          <small class="text-muted">for Nathan Blaylock Media LLC</small>
        </h1>
        <p>
          At Nathan Blaylock Media, accessible from <a href="/">https://nathanblaylock.com</a>,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Nathan Blaylock Media and how we use it.
        </p>
        <p>
