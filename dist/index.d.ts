...
export { default as GModal } from './GModal.svelte';
...
export type Variant = 'primary' | 'secondary' | 'light' | 'dark' | 'gray' | 'base-1' | 'base-2' | 'base-3' | 'base-4' | 'base-i1' | 'base-i2' | 'base-i3' | 'base-i4';
